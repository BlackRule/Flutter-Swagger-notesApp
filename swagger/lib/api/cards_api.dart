...
class CardsApi {
  ...
  Future<CardCreateRecieve> cardsCreate(CardCreateRecieve data) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'CardCreateRecieve') as CardCreateRecieve ;
    } else {
      return null;
    }
  }
  ...
  Future cardsDelete(int id) async {
    ...
    // create path and map variables
    String path = "/cards/{id}/".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<List<CardCreateRecieve>> cardsList({ String row }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return 
        (apiClient.deserialize(response.body, 'List<CardCreateRecieve>') as List).map((item) => item as CardCreateRecieve).toList();
    } else {
      return null;
    }
  }
  ...
  Future<CardUpdateDelete> cardsPartialUpdate(int id, CardUpdateDelete data) async {
    Object postBody = data;
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'CardUpdateDelete') as CardUpdateDelete ;
    } else {
      return null;
    }
  }
